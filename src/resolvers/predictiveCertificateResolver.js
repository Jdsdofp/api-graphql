...
export const predictiveCertificateResolvers = {
    Query: {
        ...
        //   return rows;
        // },
        predictiveCertificates: async (_, __, { db, empresa_id }) => {
            const [rows] = await db.query('SELECT * FROM mat_view_prod.predictive_certificate_analysis WHERE company_id = ?', [empresa_id]);
            return rows;
        },
...
//# sourceMappingURL=predictiveCertificateResolver.js.map